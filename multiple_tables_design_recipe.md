...
user_account, email_address, username, posts, title, content, number_of_views
...
-- The foreign key name is always {other_table_singular}_id
  user_account_id int,
  constraint fk_user_account foreign key(user_accoun_id)
    references user_accounts(id)
    on delete cascade
);
5. Create the tables

psql -h 127.0.0.1 music_library < seeds/social_network.sql